...
(function () {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Mateus Alcova Gonçalves'));
    ...
    */
    ...
    console.log(text.replace(/brasileiro/, 'ituano'));
    ...
    */
    ...
    console.log(text.replace(/O Centauro de Luvas/, function(str) {
    ...
    */
    ...
    function replaceDate(regexp, day, month, year) {
